...
<template>
  <div class="home mx-auto max-w-screen-xl">
    <div class="box-content">
      <div class="flex justify-between">
        <div class="pt-36">
          <h1
            class="tracking-wide text-transparent bg-clip-text bg-gradient-to-r from-white via-orange-300 to-orange-700 text-6xl uppercase"
          >
            Путешествие
          </h1>
          <h2 class="text-white text-3xl">на красную планету</h2>
        </div>
        <div class="grid grid-cols-2 gap-2 pt-20">
          ...
          >
            ...
            <h1 class="text-slate-50/40 text-xl">дней</h1>
          </div>
        </div>
      </div>
    </div>
